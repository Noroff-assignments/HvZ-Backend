    ...
    public class HvZDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Player>().HasData(
                new Player { Id = 1,   UserToken = 1,  SquadId = null, IsPatientZero = true, IsZombie = true, BiteCode = 1543, GameId = 1 },
                new Player { Id = 2,   UserToken = 2,  SquadId = 2,    IsPatientZero = false, IsZombie = false, BiteCode = 2804, GameId = 1 },
                new Player { Id = 3,   UserToken = 3,  SquadId = 2,    IsPatientZero = false, IsZombie = true, BiteCode = 3110, GameId = 1 },
                new Player { Id = 4,   UserToken = 4,  SquadId = 3,    IsPatientZero = false, IsZombie = false, BiteCode = 4975, GameId = 1 },
                new Player { Id = 5,   UserToken = 5,  SquadId = 3,    IsPatientZero = false, IsZombie = false, BiteCode = 5368, GameId = 1 },
                new Player { Id = 6,   UserToken = 6,  SquadId = null, IsPatientZero = false, IsZombie = false, BiteCode = 6729, GameId = 1 },
                new Player { Id = 7,   UserToken = 7,  SquadId = 4,    IsPatientZero = false, IsZombie = true, BiteCode = 7462, GameId = 1 },
                new Player { Id = 8,   UserToken = 8,  SquadId = 2,    IsPatientZero = false, IsZombie = false, BiteCode = 8901, GameId = 1 },
                new Player { Id = 9,   UserToken = 9,  SquadId = 1,    IsPatientZero = false, IsZombie = true, BiteCode = 9012, GameId = 1 },
                new Player { Id = 10,  UserToken = 10, SquadId = null, IsPatientZero = false, IsZombie = false, BiteCode = 1098, GameId = 1 },
                new Player { Id = 11,  UserToken = 11, SquadId = null, IsPatientZero = false, IsZombie = true, BiteCode = 2109, GameId = 1 },
                new Player { Id = 12,  UserToken = 12, SquadId = 2,    IsPatientZero = false, IsZombie = false, BiteCode = 3210, GameId = 1 },
                new Player { Id = 13,  UserToken = 13, SquadId = 4,    IsPatientZero = false, IsZombie = true, BiteCode = 8049, GameId = 1 },
                new Player { Id = 14,  UserToken = 14, SquadId = null, IsPatientZero = false, IsZombie = false, BiteCode = 9127, GameId = 1 },
                new Player { Id = 15,  UserToken = 15, SquadId = 5,    IsPatientZero = false, IsZombie = false, BiteCode = 1379, GameId = 1 },
                new Player { Id = 16,  UserToken = 16, SquadId = 3,    IsPatientZero = false, IsZombie = true, BiteCode = 2556, GameId = 1 },
                new Player { Id = 17,  UserToken = 17, SquadId = null, IsPatientZero = false, IsZombie = false, BiteCode = 1987, GameId = 1 },
                new Player { Id = 18,  UserToken = 18, SquadId = 1,    IsPatientZero = false, IsZombie = true, BiteCode = 9876, GameId = 1 },
                new Player { Id = 19,  UserToken = 19, SquadId = 5,    IsPatientZero = false, IsZombie = false, BiteCode = 3837, GameId = 1 },
                new Player { Id = 20,  UserToken = 20, SquadId = null, IsPatientZero = false, IsZombie = false, BiteCode = 4321, GameId = 1 },
                new Player { Id = 21,  UserToken = 21, SquadId = 3,    IsPatientZero = false, IsZombie = false, BiteCode = 5698, GameId = 1 },
                new Player { Id = 22,  UserToken = 22, SquadId = 5,    IsPatientZero = false, IsZombie = true, BiteCode = 6067, GameId = 1 },
                new Player { Id = 23,  UserToken = 23, SquadId = 4,    IsPatientZero = false, IsZombie = false, BiteCode = 7088, GameId = 1 },
                new Player { Id = 24,  UserToken = 24, SquadId = null, IsPatientZero = false, IsZombie = true, BiteCode = 3219, GameId = 1 },
                new Player { Id = 25,  UserToken = 25, SquadId = 4,    IsPatientZero = false, IsZombie = false, BiteCode = 2198, GameId = 1 },
                new Player { Id = 26,  UserToken = 26, SquadId = null, IsPatientZero = false, IsZombie = true, BiteCode = 8765, GameId = 1 },
                new Player { Id = 27,  UserToken = 27, SquadId = 1,    IsPatientZero = false, IsZombie = false, BiteCode = 7654, GameId = 1 },
                new Player { Id = 28,  UserToken = 28, SquadId = 4,    IsPatientZero = false, IsZombie = true, BiteCode = 8594, GameId = 1 },
                new Player { Id = 29,  UserToken = 29, SquadId = null, IsPatientZero = false, IsZombie = false, BiteCode = 5432, GameId = 1 },
                new Player { Id = 30,  UserToken = 30, SquadId = 3,    IsPatientZero = false, IsZombie = false, BiteCode = 9645, GameId = 1 },
                new Player { Id = 31,  UserToken = 31, SquadId = 5,    IsPatientZero = false, IsZombie = true, BiteCode = 1034, GameId = 1 },
                new Player { Id = 32,  UserToken = 32, SquadId = 2,    IsPatientZero = false, IsZombie = false, BiteCode = 6543, GameId = 1 },
                new Player { Id = 33,  UserToken = 33, SquadId = null, IsPatientZero = false, IsZombie = true, BiteCode = 2345, GameId = 1 },
                new Player { Id = 34,  UserToken = 34, SquadId = 2,    IsPatientZero = false, IsZombie = false, BiteCode = 3456, GameId = 1 },
                new Player { Id = 35,  UserToken = 35, SquadId = 3,    IsPatientZero = false, IsZombie = false, BiteCode = 2223, GameId = 1 },
                                       
                new Player { Id = 36,  UserToken = 36, SquadId = null, IsPatientZero = true, IsZombie = true,  BiteCode = 1543, GameId = 2 },
                new Player { Id = 37,  UserToken = 37, SquadId = 7,    IsPatientZero = false, IsZombie = false, BiteCode = 2804, GameId = 2 },
                new Player { Id = 38,  UserToken = 38, SquadId = 9,    IsPatientZero = false, IsZombie = true,  BiteCode = 3110, GameId = 2 },
                new Player { Id = 39,  UserToken = 39, SquadId = 10,   IsPatientZero = false, IsZombie = false, BiteCode = 4975, GameId = 2 },
                new Player { Id = 40,  UserToken = 40, SquadId = 8,    IsPatientZero = false, IsZombie = true,  BiteCode = 5368, GameId = 2 },
                new Player { Id = 41,  UserToken = 41, SquadId = 9,    IsPatientZero = false, IsZombie = false, BiteCode = 6729, GameId = 2 },
                new Player { Id = 42,  UserToken = 42, SquadId = 9,    IsPatientZero = false, IsZombie = false, BiteCode = 7462, GameId = 2 },
                new Player { Id = 43,  UserToken = 43, SquadId = 6,    IsPatientZero = false, IsZombie = true,  BiteCode = 8901, GameId = 2 },
                new Player { Id = 44,  UserToken = 44, SquadId = 10,   IsPatientZero = false, IsZombie = false, BiteCode = 9012, GameId = 2 },
                new Player { Id = 45,  UserToken = 45, SquadId = 6,    IsPatientZero = false, IsZombie = true,  BiteCode = 1098, GameId = 2 },
                new Player { Id = 46,  UserToken = 46, SquadId = 8,    IsPatientZero = false, IsZombie = false, BiteCode = 2109, GameId = 2 },
                new Player { Id = 47,  UserToken = 47, SquadId = 6,    IsPatientZero = false, IsZombie = false, BiteCode = 3210, GameId = 2 },
                new Player { Id = 48,  UserToken = 48, SquadId = 7,    IsPatientZero = false, IsZombie = true,  BiteCode = 8049, GameId = 2 },
                new Player { Id = 49,  UserToken = 49, SquadId = 7,    IsPatientZero = false, IsZombie = false, BiteCode = 9127, GameId = 2 },
                new Player { Id = 50,  UserToken = 50, SquadId = 9,    IsPatientZero = false, IsZombie = true,  BiteCode = 1379, GameId = 2 },
                new Player { Id = 51,  UserToken = 51, SquadId = null, IsPatientZero = false, IsZombie = false, BiteCode = 2556, GameId = 2 },
                new Player { Id = 52,  UserToken = 52, SquadId = null, IsPatientZero = false, IsZombie = true,  BiteCode = 1987, GameId = 2 },
                new Player { Id = 53,  UserToken = 53, SquadId = 10,   IsPatientZero = false, IsZombie = false, BiteCode = 9876, GameId = 2 },
                new Player { Id = 54,  UserToken = 54, SquadId = 9,    IsPatientZero = false, IsZombie = false, BiteCode = 3837, GameId = 2 },
                new Player { Id = 55,  UserToken = 55, SquadId = 9,    IsPatientZero = false, IsZombie = true,  BiteCode = 4321, GameId = 2 },
                new Player { Id = 56,  UserToken = 56, SquadId = 8,    IsPatientZero = false, IsZombie = false, BiteCode = 5698, GameId = 2 },
                new Player { Id = 57,  UserToken = 57, SquadId = null, IsPatientZero = false, IsZombie = true,  BiteCode = 6067, GameId = 2 },
                new Player { Id = 58,  UserToken = 58, SquadId = null, IsPatientZero = false, IsZombie = true,  BiteCode = 7088, GameId = 2 },
                new Player { Id = 59,  UserToken = 59, SquadId = 6,    IsPatientZero = false, IsZombie = false, BiteCode = 3219, GameId = 2 },
                new Player { Id = 60,  UserToken = 60, SquadId = 10,   IsPatientZero = false, IsZombie = true,  BiteCode = 2198, GameId = 2 },
                new Player { Id = 61,  UserToken = 61, SquadId = null, IsPatientZero = false, IsZombie = false, BiteCode = 8765, GameId = 2 },
                new Player { Id = 62,  UserToken = 62, SquadId = null, IsPatientZero = false, IsZombie = false, BiteCode = 7654, GameId = 2 },
                new Player { Id = 63,  UserToken = 63, SquadId = null, IsPatientZero = false, IsZombie = true,  BiteCode = 8594, GameId = 2 },
                new Player { Id = 64,  UserToken = 64, SquadId = null, IsPatientZero = false, IsZombie = false, BiteCode = 5432, GameId = 2 },
                new Player { Id = 65,  UserToken = 65, SquadId = 7,    IsPatientZero = false, IsZombie = true,  BiteCode = 9645, GameId = 2 },
                new Player { Id = 66,  UserToken = 66, SquadId = 10,   IsPatientZero = false, IsZombie = true,  BiteCode = 1034, GameId = 2 },
                new Player { Id = 67,  UserToken = 67, SquadId = 10,   IsPatientZero = false, IsZombie = false, BiteCode = 6543, GameId = 2 },
                new Player { Id = 68,  UserToken = 68, SquadId = 8,    IsPatientZero = false, IsZombie = true,  BiteCode = 2345, GameId = 2 },
                new Player { Id = 69,  UserToken = 69, SquadId = 6,    IsPatientZero = false, IsZombie = false, BiteCode = 3456, GameId = 2 },
                new Player { Id = 70,  UserToken = 70, SquadId = null, IsPatientZero = false, IsZombie = false, BiteCode = 2223, GameId = 2 },
                                       
                new Player { Id = 71,  UserToken = 2,  SquadId = null, IsPatientZero = true, IsZombie = true,   BiteCode = 2804, GameId = 3 },
                new Player { Id = 72,  UserToken = 4,  SquadId = 11,   IsPatientZero = false, IsZombie = false, BiteCode = 4975, GameId = 3 },
                new Player { Id = 73,  UserToken = 5,  SquadId = 12,   IsPatientZero = false, IsZombie = false, BiteCode = 5368, GameId = 3 },
                new Player { Id = 74,  UserToken = 6,  SquadId = null, IsPatientZero = false, IsZombie = true,  BiteCode = 6729, GameId = 3 },
                new Player { Id = 75,  UserToken = 8,  SquadId = null, IsPatientZero = false, IsZombie = true,  BiteCode = 8901, GameId = 3 },
                new Player { Id = 76,  UserToken = 10, SquadId = null, IsPatientZero = false, IsZombie = false, BiteCode = 1098, GameId = 3 },
                new Player { Id = 77,  UserToken = 12, SquadId = 13,   IsPatientZero = false, IsZombie = true,  BiteCode = 3210, GameId = 3 },
                new Player { Id = 78,  UserToken = 14, SquadId = 14,   IsPatientZero = false, IsZombie = true,  BiteCode = 9127, GameId = 3 },
                new Player { Id = 79,  UserToken = 15, SquadId = null, IsPatientZero = false, IsZombie = true,  BiteCode = 1379, GameId = 3 },
                new Player { Id = 80,  UserToken = 17, SquadId = null, IsPatientZero = false, IsZombie = false, BiteCode = 1987, GameId = 3 },
                new Player { Id = 81,  UserToken = 19, SquadId = null, IsPatientZero = false, IsZombie = false, BiteCode = 3837, GameId = 3 },
                new Player { Id = 82,  UserToken = 20, SquadId = null, IsPatientZero = false, IsZombie = true,  BiteCode = 4321, GameId = 3 },
                new Player { Id = 83,  UserToken = 21, SquadId = 11,   IsPatientZero = false, IsZombie = false, BiteCode = 5698, GameId = 3 },
                new Player { Id = 84,  UserToken = 23, SquadId = 13,   IsPatientZero = false, IsZombie = false, BiteCode = 7088, GameId = 3 },
                new Player { Id = 85,  UserToken = 25, SquadId = 13,   IsPatientZero = false, IsZombie = true,  BiteCode = 2198, GameId = 3 },
                new Player { Id = 86,  UserToken = 27, SquadId = null, IsPatientZero = false, IsZombie = true,  BiteCode = 7654, GameId = 3 },
                new Player { Id = 87,  UserToken = 29, SquadId = 14,   IsPatientZero = false, IsZombie = false, BiteCode = 5432, GameId = 3 },
                new Player { Id = 88,  UserToken = 30, SquadId = null, IsPatientZero = false, IsZombie = false, BiteCode = 9645, GameId = 3 },
                new Player { Id = 89,  UserToken = 32, SquadId = 12,   IsPatientZero = false, IsZombie = false, BiteCode = 6543, GameId = 3 },
                new Player { Id = 90,  UserToken = 34, SquadId = 12,   IsPatientZero = false, IsZombie = false, BiteCode = 3456, GameId = 3 },
                new Player { Id = 91,  UserToken = 35, SquadId = 12,   IsPatientZero = false, IsZombie = false, BiteCode = 2223, GameId = 3 },
                new Player { Id = 92,  UserToken = 37, SquadId = null, IsPatientZero = false, IsZombie = false, BiteCode = 2804, GameId = 3 },
                new Player { Id = 93,  UserToken = 39, SquadId = 13,   IsPatientZero = false, IsZombie = true,  BiteCode = 4975, GameId = 3 },
                new Player { Id = 94,  UserToken = 41, SquadId = 11,   IsPatientZero = false, IsZombie = false, BiteCode = 6729, GameId = 3 },
                new Player { Id = 95,  UserToken = 42, SquadId = null, IsPatientZero = false, IsZombie = false, BiteCode = 7462, GameId = 3 },
                new Player { Id = 96,  UserToken = 44, SquadId = null, IsPatientZero = false, IsZombie = true,  BiteCode = 9012, GameId = 3 },
                new Player { Id = 97,  UserToken = 46, SquadId = 11,   IsPatientZero = false, IsZombie = false, BiteCode = 2109, GameId = 3 },
                new Player { Id = 98,  UserToken = 47, SquadId = 13,   IsPatientZero = false, IsZombie = false, BiteCode = 3210, GameId = 3 },
                new Player { Id = 99,  UserToken = 49, SquadId = null, IsPatientZero = false, IsZombie = true,  BiteCode = 9127, GameId = 3 },
                new Player { Id = 100, UserToken = 51, SquadId = 13,   IsPatientZero = false, IsZombie = false, BiteCode = 2556, GameId = 3 },
                new Player { Id = 101, UserToken = 53, SquadId = null, IsPatientZero = false, IsZombie = false, BiteCode = 9876, GameId = 3 },
                new Player { Id = 102, UserToken = 54, SquadId = 14,   IsPatientZero = false, IsZombie = true,  BiteCode = 3837, GameId = 3 },
                new Player { Id = 103, UserToken = 56, SquadId = null, IsPatientZero = false, IsZombie = false, BiteCode = 5698, GameId = 3 },
                new Player { Id = 104, UserToken = 59, SquadId = null, IsPatientZero = false, IsZombie = false, BiteCode = 3219, GameId = 3 },
                new Player { Id = 105, UserToken = 61, SquadId = 11,   IsPatientZero = false, IsZombie = true,  BiteCode = 8765, GameId = 3 },
                new Player { Id = 106, UserToken = 62, SquadId = null, IsPatientZero = false, IsZombie = false, BiteCode = 7654, GameId = 3 },
                new Player { Id = 107, UserToken = 64, SquadId = 13,   IsPatientZero = false, IsZombie = true,  BiteCode = 5432, GameId = 3 },
                new Player { Id = 108, UserToken = 67, SquadId = null, IsPatientZero = false, IsZombie = false, BiteCode = 6543, GameId = 3 },
                new Player { Id = 109, UserToken = 69, SquadId = 14,   IsPatientZero = false, IsZombie = false, BiteCode = 3456, GameId = 3 },
                new Player { Id = 110, UserToken = 70, SquadId = 13,   IsPatientZero = false, IsZombie = true,  BiteCode = 2223, GameId = 3 },
                                       
                new Player { Id = 111, UserToken = 4,  SquadId = null, IsPatientZero = true,  IsZombie = true,  BiteCode = 4975, GameId = 4 },
                new Player { Id = 112, UserToken = 5,  SquadId = null, IsPatientZero = false, IsZombie = false, BiteCode = 5368, GameId = 4 },
                new Player { Id = 113, UserToken = 10, SquadId = null, IsPatientZero = false, IsZombie = false, BiteCode = 1098, GameId = 4 },
                new Player { Id = 114, UserToken = 17, SquadId = null, IsPatientZero = false, IsZombie = false, BiteCode = 1987, GameId = 4 },
                new Player { Id = 115, UserToken = 19, SquadId = null, IsPatientZero = false, IsZombie = false, BiteCode = 3837, GameId = 4 },
                new Player { Id = 116, UserToken = 21, SquadId = null, IsPatientZero = false, IsZombie = false, BiteCode = 5698, GameId = 4 },
                new Player { Id = 117, UserToken = 23, SquadId = null, IsPatientZero = false, IsZombie = false, BiteCode = 7088, GameId = 4 },
                new Player { Id = 118, UserToken = 29, SquadId = null, IsPatientZero = false, IsZombie = false, BiteCode = 5432, GameId = 4 },
                new Player { Id = 119, UserToken = 30, SquadId = null, IsPatientZero = false, IsZombie = false, BiteCode = 9645, GameId = 4 },
                new Player { Id = 120, UserToken = 32, SquadId = null, IsPatientZero = false, IsZombie = false, BiteCode = 6543, GameId = 4 },
                new Player { Id = 121, UserToken = 34, SquadId = null, IsPatientZero = false, IsZombie = false, BiteCode = 3456, GameId = 4 },
                new Player { Id = 122, UserToken = 35, SquadId = null, IsPatientZero = false, IsZombie = false, BiteCode = 2223, GameId = 4 },
                new Player { Id = 123, UserToken = 37, SquadId = null, IsPatientZero = false, IsZombie = false, BiteCode = 2804, GameId = 4 },
                new Player { Id = 124, UserToken = 41, SquadId = null, IsPatientZero = false, IsZombie = false, BiteCode = 6729, GameId = 4 },
                new Player { Id = 125, UserToken = 42, SquadId = null, IsPatientZero = false, IsZombie = false, BiteCode = 7462, GameId = 4 },
                new Player { Id = 126, UserToken = 46, SquadId = null, IsPatientZero = false, IsZombie = false, BiteCode = 2109, GameId = 4 },
                new Player { Id = 127, UserToken = 47, SquadId = null, IsPatientZero = false, IsZombie = false, BiteCode = 3210, GameId = 4 },
                new Player { Id = 128, UserToken = 51, SquadId = null, IsPatientZero = false, IsZombie = false, BiteCode = 2556, GameId = 4 },
                new Player { Id = 129, UserToken = 53, SquadId = null, IsPatientZero = false, IsZombie = false, BiteCode = 9876, GameId = 4 },
                new Player { Id = 130, UserToken = 56, SquadId = null, IsPatientZero = false, IsZombie = false, BiteCode = 5698, GameId = 4 },
                new Player { Id = 131, UserToken = 59, SquadId = null, IsPatientZero = false, IsZombie = false, BiteCode = 3219, GameId = 4 },
                new Player { Id = 132, UserToken = 62, SquadId = null, IsPatientZero = false, IsZombie = false, BiteCode = 7654, GameId = 4 },
                new Player { Id = 133, UserToken = 67, SquadId = null, IsPatientZero = false, IsZombie = false, BiteCode = 6543, GameId = 4 },
                new Player { Id = 134, UserToken = 69, SquadId = null, IsPatientZero = false, IsZombie = false, BiteCode = 3456, GameId = 4 }
                );
            #endregion
