    ...
    public class HvZDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Map>().HasData(
                new Map { Id = 1, Latitude = 55.642780, Longitude = 12.271445, MapName = "Experis Academy Denmark", MapDescription = "The location for the Experis Academy World Championship 2023." },
                new Map { Id = 2, Latitude = 55.642780, Longitude = 12.271445, MapName = "Experis Academy Denmark", MapDescription = "The location for the Experis Academy World Championship 2023." },
                new Map { Id = 3, Latitude = 55.642780, Longitude = 12.271445, MapName = "Experis Academy Denmark", MapDescription = "The location for the Experis Academy World Championship 2023." },
                new Map { Id = 4, Latitude = 55.642780, Longitude = 12.271445, MapName = "Experis Academy Denmark", MapDescription = "The location for the Experis Academy World Championship 2023." }
                );
            ...
            modelBuilder.Entity<Player>().HasData(
                new Player { Id = 1, UserID = "acc85530-f88c-4de6-86e2-083bc5f86641", SquadId = null, IsPatientZero = true, IsZombie = true, BiteCode = 1543, GameId = 1 },
                new Player { Id = 2, UserID = "d19c226a-22fb-4e6f-81a4-c1d153f929b7", SquadId = 2, IsPatientZero = false, IsZombie = false, BiteCode = 2804, GameId = 1 },
                new Player { Id = 3, UserID = "40885ab0-a5bb-4d76-a5d5-5db34156912b", SquadId = 2, IsPatientZero = false, IsZombie = true, BiteCode = 3110, GameId = 1 },
                new Player { Id = 4, UserID = "70a4f7b8-a619-438f-b309-fd333a9e8577", SquadId = 3, IsPatientZero = false, IsZombie = false, BiteCode = 4975, GameId = 1 },
                new Player { Id = 5, UserID = "1861c804-6669-49bb-b35b-5b2c191b850c", SquadId = 3, IsPatientZero = false, IsZombie = false, BiteCode = 5368, GameId = 1 },
                new Player { Id = 6, UserID = "245b9d79-0aa1-435d-9878-4896744f221b", SquadId = null, IsPatientZero = false, IsZombie = false, BiteCode = 6729, GameId = 1 },
                new Player { Id = 7, UserID = "25b14121-60e7-4126-9926-34ccefc08ec2", SquadId = 4, IsPatientZero = false, IsZombie = true, BiteCode = 7462, GameId = 1 },
                new Player { Id = 8, UserID = "f52236fb-2ab2-4345-bfe5-bfa82b776cf1", SquadId = 2, IsPatientZero = false, IsZombie = false, BiteCode = 8901, GameId = 1 },
                new Player { Id = 9, UserID = "1e660e8f-893c-4224-82af-8f80d332d4a6", SquadId = 1, IsPatientZero = false, IsZombie = true, BiteCode = 9012, GameId = 1 },
                new Player { Id = 10, UserID = "fb55b851-bfeb-4781-8e8a-bc2af03fea63", SquadId = null, IsPatientZero = false, IsZombie = false, BiteCode = 1098, GameId = 1 },
                new Player { Id = 11, UserID = "f8c97264f-0c1b-4dca-9cc3-fe786f8f0962", SquadId = null, IsPatientZero = false, IsZombie = true, BiteCode = 2109, GameId = 1 },
                new Player { Id = 12, UserID = "203837e7-29b9-400f-bdd8-5094abb4f3ab", SquadId = 2, IsPatientZero = false, IsZombie = false, BiteCode = 3210, GameId = 1 },
                new Player { Id = 13, UserID = "f0ecd9f5-ee43-4fbf-bc01-7a6f6d6e52a2", SquadId = 4, IsPatientZero = false, IsZombie = true, BiteCode = 8049, GameId = 1 },
                new Player { Id = 14, UserID = "1ca26c1d-7737-44aa-abc3-4120d1e84cde", SquadId = null, IsPatientZero = false, IsZombie = false, BiteCode = 9127, GameId = 1 },
                new Player { Id = 15, UserID = "87e22096-fce7-413d-a9e7-1ae785ef39ac", SquadId = 5, IsPatientZero = false, IsZombie = false, BiteCode = 1379, GameId = 1 },
                new Player { Id = 16, UserID = "da02dda1-0510-4f20-8cd7-1e22c6e4321e", SquadId = 3, IsPatientZero = false, IsZombie = true, BiteCode = 2556, GameId = 1 },
                new Player { Id = 17, UserID = "61bb9ef9-9f9e-4ce5-b466-4add87940ed8", SquadId = null, IsPatientZero = false, IsZombie = false, BiteCode = 1987, GameId = 1 },
                new Player { Id = 18, UserID = "ed860bdc-50ff-4637-81c2-af42cba90f54", SquadId = 1, IsPatientZero = false, IsZombie = true, BiteCode = 9876, GameId = 1 },
                new Player { Id = 19, UserID = "db7df012-1f85-44f4-a6b8-6bf95bc9b715", SquadId = 5, IsPatientZero = false, IsZombie = false, BiteCode = 3837, GameId = 1 },
                new Player { Id = 20, UserID = "d676b8d0-8353-4e0e-900c-335719b031eb", SquadId = null, IsPatientZero = false, IsZombie = false, BiteCode = 4321, GameId = 1 },
                new Player { Id = 21, UserID = "7c303786-36f5-410d-bae1-8fbcb92c6603", SquadId = 3, IsPatientZero = false, IsZombie = false, BiteCode = 5698, GameId = 1 },
                new Player { Id = 22, UserID = "1d270eb6-53bf-440b-8eb9-c71feedf49dd", SquadId = 5, IsPatientZero = false, IsZombie = true, BiteCode = 6067, GameId = 1 },
                new Player { Id = 23, UserID = "ba89254d-974f-4d64-abe8-8c2ddeabc1b7", SquadId = 4, IsPatientZero = false, IsZombie = false, BiteCode = 7088, GameId = 1 },
                new Player { Id = 24, UserID = "49c024eb-d205-4587-bfd6-e5dbfb1702f3", SquadId = null, IsPatientZero = false, IsZombie = true, BiteCode = 3219, GameId = 1 },
                new Player { Id = 25, UserID = "43f44f34-5ee1-4b80-95c2-0cf2c2cb0776", SquadId = 4, IsPatientZero = false, IsZombie = false, BiteCode = 2198, GameId = 1 },
                new Player { Id = 26, UserID = "b25e5332-0308-4e1c-b137-dae33588ea6c", SquadId = null, IsPatientZero = false, IsZombie = true, BiteCode = 8765, GameId = 1 },
                new Player { Id = 27, UserID = "0920e3c1-f978-4b70-a7f5-9c766595b475", SquadId = 1, IsPatientZero = false, IsZombie = false, BiteCode = 7654, GameId = 1 },
                new Player { Id = 28, UserID = "7b6371fd-a26f-41b0-9056-c793ff7e07d6", SquadId = 4, IsPatientZero = false, IsZombie = true, BiteCode = 8594, GameId = 1 },
                new Player { Id = 29, UserID = "6251cd7b-0a79-49e6-b4f2-b153bf21ac97", SquadId = null, IsPatientZero = false, IsZombie = false, BiteCode = 5432, GameId = 1 },
                new Player { Id = 30, UserID = "a56481e5-9c6a-4aef-9e07-c534a33f0097", SquadId = 3, IsPatientZero = false, IsZombie = false, BiteCode = 9645, GameId = 1 },
                new Player { Id = 31, UserID = "2454c85a-b5b1-4c08-b265-e8e5a7ced4b7", SquadId = 5, IsPatientZero = false, IsZombie = true, BiteCode = 1034, GameId = 1 },
                new Player { Id = 32, UserID = "10db85db-9750-415f-b6f3-333bdd678758", SquadId = 2, IsPatientZero = false, IsZombie = false, BiteCode = 6543, GameId = 1 },
                new Player { Id = 33, UserID = "e386781a-bda7-4dba-a504-10999ed91267", SquadId = null, IsPatientZero = false, IsZombie = true, BiteCode = 2345, GameId = 1 },
                new Player { Id = 34, UserID = "01731ab5-8f28-4a7b-afe7-c892fc5bd8d9", SquadId = 2, IsPatientZero = false, IsZombie = false, BiteCode = 3456, GameId = 1 },
                new Player { Id = 35, UserID = "a7551a99-7573-4abc-afae-b7186d35fb5a", SquadId = 3, IsPatientZero = false, IsZombie = false, BiteCode = 2223, GameId = 1 },

                new Player { Id = 36, UserID = "542189b8-9df5-41d4-aece-5bff052a53f9", SquadId = null, IsPatientZero = true, IsZombie = true, BiteCode = 1543, GameId = 2 },
                new Player { Id = 37, UserID = "bbf55298-5e22-49a3-945c-b4d79346a3ed", SquadId = 7, IsPatientZero = false, IsZombie = false, BiteCode = 2804, GameId = 2 },
                new Player { Id = 38, UserID = "dba845f7-fd61-4f1a-b8a6-4c67de2e8612", SquadId = 9, IsPatientZero = false, IsZombie = true, BiteCode = 3110, GameId = 2 },
                new Player { Id = 39, UserID = "02e94a01-3d77-477f-8598-a87a0a91ea1a", SquadId = 10, IsPatientZero = false, IsZombie = false, BiteCode = 4975, GameId = 2 },
                new Player { Id = 40, UserID = "430d1e90-27d9-47ca-afa9-8f6c41d1e272", SquadId = 8, IsPatientZero = false, IsZombie = true, BiteCode = 5368, GameId = 2 },
                new Player { Id = 41, UserID = "7596aaf8-c8a6-449a-be88-e2e0263e51de", SquadId = 9, IsPatientZero = false, IsZombie = false, BiteCode = 6729, GameId = 2 },
                new Player { Id = 42, UserID = "eb78fe31-2baf-495c-bf32-6ac91a050d7e", SquadId = 9, IsPatientZero = false, IsZombie = false, BiteCode = 7462, GameId = 2 },
                new Player { Id = 43, UserID = "56e015d1-9ddf-4b6b-bc56-47b481696b04", SquadId = 6, IsPatientZero = false, IsZombie = true, BiteCode = 8901, GameId = 2 },
                new Player { Id = 44, UserID = "587e6433-36f0-4ec3-825f-318aecf427fb", SquadId = 10, IsPatientZero = false, IsZombie = false, BiteCode = 9012, GameId = 2 },
                new Player { Id = 45, UserID = "726f19c4-d67e-4584-aaf9-eb74eb9a6309", SquadId = 6, IsPatientZero = false, IsZombie = true, BiteCode = 1098, GameId = 2 },
                new Player { Id = 46, UserID = "98ae3b89-2b66-4113-b369-b06e7af7960e", SquadId = 8, IsPatientZero = false, IsZombie = false, BiteCode = 2109, GameId = 2 },
                new Player { Id = 47, UserID = "c6561be2-a927-4cb4-86ad-42867a09f06d", SquadId = 6, IsPatientZero = false, IsZombie = false, BiteCode = 3210, GameId = 2 },
                new Player { Id = 48, UserID = "247cb94a-606a-44b2-968f-244f26544797", SquadId = 7, IsPatientZero = false, IsZombie = true, BiteCode = 8049, GameId = 2 },
                new Player { Id = 49, UserID = "38de1747-35cf-41d0-a275-e6a5e84b0b2e", SquadId = 7, IsPatientZero = false, IsZombie = false, BiteCode = 9127, GameId = 2 },
                new Player { Id = 50, UserID = "9ce13bc9-7f8b-4be8-97c7-bd8d9370deb0", SquadId = 9, IsPatientZero = false, IsZombie = true, BiteCode = 1379, GameId = 2 },
                new Player { Id = 51, UserID = "9d394a75-27a0-4a21-b5f3-e0938da2725c", SquadId = null, IsPatientZero = false, IsZombie = false, BiteCode = 2556, GameId = 2 },
                new Player { Id = 52, UserID = "99000a0c-b069-4f61-9edd-0fc69a8accce", SquadId = null, IsPatientZero = false, IsZombie = true, BiteCode = 1987, GameId = 2 },
                new Player { Id = 53, UserID = "4afba9be-cd98-4070-9cb2-de3aa91e7203", SquadId = 10, IsPatientZero = false, IsZombie = false, BiteCode = 9876, GameId = 2 },
                new Player { Id = 54, UserID = "8e942c88-8b46-451c-a594-1029e59ffffe", SquadId = 9, IsPatientZero = false, IsZombie = false, BiteCode = 3837, GameId = 2 },
                new Player { Id = 55, UserID = "bf84285f-8bea-4639-bff5-404812e17e02", SquadId = 9, IsPatientZero = false, IsZombie = true, BiteCode = 4321, GameId = 2 },
                new Player { Id = 56, UserID = "6f90589f-df6b-4e3e-8adb-3986b1b1ae20", SquadId = 8, IsPatientZero = false, IsZombie = false, BiteCode = 5698, GameId = 2 },
                new Player { Id = 57, UserID = "c1dec74f-fc72-4f64-8cd1-4c35c48dba4b", SquadId = null, IsPatientZero = false, IsZombie = true, BiteCode = 6067, GameId = 2 },
                new Player { Id = 58, UserID = "00a13984-f498-4161-b448-ada0d47b86d4", SquadId = null, IsPatientZero = false, IsZombie = true, BiteCode = 7088, GameId = 2 },
                new Player { Id = 59, UserID = "4306cf6f-f263-4bcc-a5af-5a4083bf2700", SquadId = 6, IsPatientZero = false, IsZombie = false, BiteCode = 3219, GameId = 2 },
                new Player { Id = 60, UserID = "4655a760-e6b2-4035-b39c-cf1156f4a0fa", SquadId = 10, IsPatientZero = false, IsZombie = true, BiteCode = 2198, GameId = 2 },
                new Player { Id = 61, UserID = "8fd9439a-d6f1-42e0-9d7e-04c8e8a0554b", SquadId = null, IsPatientZero = false, IsZombie = false, BiteCode = 8765, GameId = 2 },
                new Player { Id = 62, UserID = "4fef8bff-b177-4919-a3b1-8d5b81bccedd", SquadId = null, IsPatientZero = false, IsZombie = false, BiteCode = 7654, GameId = 2 },
                new Player { Id = 63, UserID = "82f60c88-dfcf-4993-96ca-a68188a6a109", SquadId = null, IsPatientZero = false, IsZombie = true, BiteCode = 8594, GameId = 2 },
                new Player { Id = 64, UserID = "135ac31d-9dd8-4ebf-b1ea-8e530e86dfc3", SquadId = null, IsPatientZero = false, IsZombie = false, BiteCode = 5432, GameId = 2 },
                new Player { Id = 65, UserID = "fd9ea2b3-f9a3-447b-a614-ef6c44f4b0c6", SquadId = 7, IsPatientZero = false, IsZombie = true, BiteCode = 9645, GameId = 2 },
                new Player { Id = 66, UserID = "b12a9834-293d-47d3-b6b4-5f8f57c1d092", SquadId = 10, IsPatientZero = false, IsZombie = true, BiteCode = 1034, GameId = 2 },
                new Player { Id = 67, UserID = "75eaa26a-6552-4822-8973-94948ccafb22", SquadId = 10, IsPatientZero = false, IsZombie = false, BiteCode = 6543, GameId = 2 },
                new Player { Id = 68, UserID = "1a91b5d0-06df-4eb6-911d-2ce1a9766a9b", SquadId = 8, IsPatientZero = false, IsZombie = true, BiteCode = 2345, GameId = 2 },
                new Player { Id = 69, UserID = "215a49a4-d9b5-4e86-86ba-35d69781649e", SquadId = 6, IsPatientZero = false, IsZombie = false, BiteCode = 3456, GameId = 2 },
                new Player { Id = 70, UserID = "5f70e435-d750-4961-a790-704312ae1336", SquadId = null, IsPatientZero = false, IsZombie = false, BiteCode = 2223, GameId = 2 },

                new Player { Id = 71, UserID = "d19c226a-22fb-4e6f-81a4-c1d153f929b7", SquadId = null, IsPatientZero = true, IsZombie = true, BiteCode = 2804, GameId = 3 },
                new Player { Id = 72, UserID = "70a4f7b8-a619-438f-b309-fd333a9e8577", SquadId = 11, IsPatientZero = false, IsZombie = false, BiteCode = 4975, GameId = 3 },
                new Player { Id = 73, UserID = "1861c804-6669-49bb-b35b-5b2c191b850c", SquadId = 12, IsPatientZero = false, IsZombie = false, BiteCode = 5368, GameId = 3 },
                new Player { Id = 74, UserID = "245b9d79-0aa1-435d-9878-4896744f221b", SquadId = null, IsPatientZero = false, IsZombie = true, BiteCode = 6729, GameId = 3 },
                new Player { Id = 75, UserID = "f52236fb-2ab2-4345-bfe5-bfa82b776cf1", SquadId = null, IsPatientZero = false, IsZombie = true, BiteCode = 8901, GameId = 3 },
                new Player { Id = 76, UserID = "fb55b851-bfeb-4781-8e8a-bc2af03fea63", SquadId = null, IsPatientZero = false, IsZombie = false, BiteCode = 1098, GameId = 3 },
                new Player { Id = 77, UserID = "203837e7-29b9-400f-bdd8-5094abb4f3ab", SquadId = 13, IsPatientZero = false, IsZombie = true, BiteCode = 3210, GameId = 3 },
                new Player { Id = 78, UserID = "1ca26c1d-7737-44aa-abc3-4120d1e84cde", SquadId = 14, IsPatientZero = false, IsZombie = true, BiteCode = 9127, GameId = 3 },
                new Player { Id = 79, UserID = "87e22096-fce7-413d-a9e7-1ae785ef39ac", SquadId = null, IsPatientZero = false, IsZombie = true, BiteCode = 1379, GameId = 3 },
                new Player { Id = 80, UserID = "61bb9ef9-9f9e-4ce5-b466-4add87940ed8", SquadId = null, IsPatientZero = false, IsZombie = false, BiteCode = 1987, GameId = 3 },
                new Player { Id = 81, UserID = "db7df012-1f85-44f4-a6b8-6bf95bc9b715", SquadId = null, IsPatientZero = false, IsZombie = false, BiteCode = 3837, GameId = 3 },
                new Player { Id = 82, UserID = "d676b8d0-8353-4e0e-900c-335719b031eb", SquadId = null, IsPatientZero = false, IsZombie = true, BiteCode = 4321, GameId = 3 },
                new Player { Id = 83, UserID = "7c303786-36f5-410d-bae1-8fbcb92c6603", SquadId = 11, IsPatientZero = false, IsZombie = false, BiteCode = 5698, GameId = 3 },
                new Player { Id = 84, UserID = "ba89254d-974f-4d64-abe8-8c2ddeabc1b7", SquadId = 13, IsPatientZero = false, IsZombie = false, BiteCode = 7088, GameId = 3 },
                new Player { Id = 85, UserID = "43f44f34-5ee1-4b80-95c2-0cf2c2cb0776", SquadId = 13, IsPatientZero = false, IsZombie = true, BiteCode = 2198, GameId = 3 },
                new Player { Id = 86, UserID = "0920e3c1-f978-4b70-a7f5-9c766595b475", SquadId = null, IsPatientZero = false, IsZombie = true, BiteCode = 7654, GameId = 3 },
                new Player { Id = 87, UserID = "6251cd7b-0a79-49e6-b4f2-b153bf21ac97", SquadId = 14, IsPatientZero = false, IsZombie = false, BiteCode = 5432, GameId = 3 },
                new Player { Id = 88, UserID = "a56481e5-9c6a-4aef-9e07-c534a33f0097", SquadId = null, IsPatientZero = false, IsZombie = false, BiteCode = 9645, GameId = 3 },
                new Player { Id = 89, UserID = "10db85db-9750-415f-b6f3-333bdd678758", SquadId = 12, IsPatientZero = false, IsZombie = false, BiteCode = 6543, GameId = 3 },
                new Player { Id = 90, UserID = "01731ab5-8f28-4a7b-afe7-c892fc5bd8d9", SquadId = 12, IsPatientZero = false, IsZombie = false, BiteCode = 3456, GameId = 3 },
                new Player { Id = 91, UserID = "a7551a99-7573-4abc-afae-b7186d35fb5a", SquadId = 12, IsPatientZero = false, IsZombie = false, BiteCode = 2223, GameId = 3 },
                new Player { Id = 92, UserID = "bbf55298-5e22-49a3-945c-b4d79346a3ed", SquadId = null, IsPatientZero = false, IsZombie = false, BiteCode = 2804, GameId = 3 },
                new Player { Id = 93, UserID = "02e94a01-3d77-477f-8598-a87a0a91ea1a", SquadId = 13, IsPatientZero = false, IsZombie = true, BiteCode = 4975, GameId = 3 },
                new Player { Id = 94, UserID = "7596aaf8-c8a6-449a-be88-e2e0263e51de", SquadId = 11, IsPatientZero = false, IsZombie = false, BiteCode = 6729, GameId = 3 },
                new Player { Id = 95, UserID = "eb78fe31-2baf-495c-bf32-6ac91a050d7e", SquadId = null, IsPatientZero = false, IsZombie = false, BiteCode = 7462, GameId = 3 },
                new Player { Id = 96, UserID = "587e6433-36f0-4ec3-825f-318aecf427fb", SquadId = null, IsPatientZero = false, IsZombie = true, BiteCode = 9012, GameId = 3 },
                new Player { Id = 97, UserID = "98ae3b89-2b66-4113-b369-b06e7af7960e", SquadId = 11, IsPatientZero = false, IsZombie = false, BiteCode = 2109, GameId = 3 },
                new Player { Id = 98, UserID = "c6561be2-a927-4cb4-86ad-42867a09f06d", SquadId = 13, IsPatientZero = false, IsZombie = false, BiteCode = 3210, GameId = 3 },
                new Player { Id = 99, UserID = "38de1747-35cf-41d0-a275-e6a5e84b0b2e", SquadId = null, IsPatientZero = false, IsZombie = true, BiteCode = 9127, GameId = 3 },
                new Player { Id = 100, UserID = "9d394a75-27a0-4a21-b5f3-e0938da2725c", SquadId = 13, IsPatientZero = false, IsZombie = false, BiteCode = 2556, GameId = 3 },
                new Player { Id = 101, UserID = "4afba9be-cd98-4070-9cb2-de3aa91e7203", SquadId = null, IsPatientZero = false, IsZombie = false, BiteCode = 9876, GameId = 3 },
                new Player { Id = 102, UserID = "8e942c88-8b46-451c-a594-1029e59ffffe", SquadId = 14, IsPatientZero = false, IsZombie = true, BiteCode = 3837, GameId = 3 },
                new Player { Id = 103, UserID = "6f90589f-df6b-4e3e-8adb-3986b1b1ae20", SquadId = null, IsPatientZero = false, IsZombie = false, BiteCode = 5698, GameId = 3 },
                new Player { Id = 104, UserID = "4306cf6f-f263-4bcc-a5af-5a4083bf2700", SquadId = null, IsPatientZero = false, IsZombie = false, BiteCode = 3219, GameId = 3 },
                new Player { Id = 105, UserID = "8fd9439a-d6f1-42e0-9d7e-04c8e8a0554b", SquadId = 11, IsPatientZero = false, IsZombie = true, BiteCode = 8765, GameId = 3 },
                new Player { Id = 106, UserID = "4fef8bff-b177-4919-a3b1-8d5b81bccedd", SquadId = null, IsPatientZero = false, IsZombie = false, BiteCode = 7654, GameId = 3 },
                new Player { Id = 107, UserID = "135ac31d-9dd8-4ebf-b1ea-8e530e86dfc3", SquadId = 13, IsPatientZero = false, IsZombie = true, BiteCode = 5432, GameId = 3 },
                new Player { Id = 108, UserID = "75eaa26a-6552-4822-8973-94948ccafb22", SquadId = null, IsPatientZero = false, IsZombie = false, BiteCode = 6543, GameId = 3 },
                new Player { Id = 109, UserID = "215a49a4-d9b5-4e86-86ba-35d69781649e", SquadId = 14, IsPatientZero = false, IsZombie = false, BiteCode = 3456, GameId = 3 },
                new Player { Id = 110, UserID = "5f70e435-d750-4961-a790-704312ae1336", SquadId = 13, IsPatientZero = false, IsZombie = true, BiteCode = 2223, GameId = 3 },

                new Player { Id = 111, UserID = "70a4f7b8-a619-438f-b309-fd333a9e8577", SquadId = null, IsPatientZero = true, IsZombie = true, BiteCode = 4975, GameId = 4 },
                new Player { Id = 112, UserID = "1861c804-6669-49bb-b35b-5b2c191b850c", SquadId = null, IsPatientZero = false, IsZombie = false, BiteCode = 5368, GameId = 4 },
                new Player { Id = 113, UserID = "fb55b851-bfeb-4781-8e8a-bc2af03fea63", SquadId = null, IsPatientZero = false, IsZombie = false, BiteCode = 1098, GameId = 4 },
                new Player { Id = 114, UserID = "61bb9ef9-9f9e-4ce5-b466-4add87940ed8", SquadId = null, IsPatientZero = false, IsZombie = false, BiteCode = 1987, GameId = 4 },
                new Player { Id = 115, UserID = "db7df012-1f85-44f4-a6b8-6bf95bc9b715", SquadId = null, IsPatientZero = false, IsZombie = false, BiteCode = 3837, GameId = 4 },
                new Player { Id = 116, UserID = "7c303786-36f5-410d-bae1-8fbcb92c6603", SquadId = null, IsPatientZero = false, IsZombie = false, BiteCode = 5698, GameId = 4 },
                new Player { Id = 117, UserID = "ba89254d-974f-4d64-abe8-8c2ddeabc1b7", SquadId = null, IsPatientZero = false, IsZombie = false, BiteCode = 7088, GameId = 4 },
                new Player { Id = 118, UserID = "6251cd7b-0a79-49e6-b4f2-b153bf21ac97", SquadId = null, IsPatientZero = false, IsZombie = false, BiteCode = 5432, GameId = 4 },
                new Player { Id = 119, UserID = "a56481e5-9c6a-4aef-9e07-c534a33f0097", SquadId = null, IsPatientZero = false, IsZombie = false, BiteCode = 9645, GameId = 4 },
                new Player { Id = 120, UserID = "10db85db-9750-415f-b6f3-333bdd678758", SquadId = null, IsPatientZero = false, IsZombie = false, BiteCode = 6543, GameId = 4 },
                new Player { Id = 121, UserID = "01731ab5-8f28-4a7b-afe7-c892fc5bd8d9", SquadId = null, IsPatientZero = false, IsZombie = false, BiteCode = 3456, GameId = 4 },
                new Player { Id = 122, UserID = "a7551a99-7573-4abc-afae-b7186d35fb5a", SquadId = null, IsPatientZero = false, IsZombie = false, BiteCode = 2223, GameId = 4 },
                new Player { Id = 123, UserID = "bbf55298-5e22-49a3-945c-b4d79346a3ed", SquadId = null, IsPatientZero = false, IsZombie = false, BiteCode = 2804, GameId = 4 },
                new Player { Id = 124, UserID = "7596aaf8-c8a6-449a-be88-e2e0263e51de", SquadId = null, IsPatientZero = false, IsZombie = false, BiteCode = 6729, GameId = 4 },
                new Player { Id = 125, UserID = "eb78fe31-2baf-495c-bf32-6ac91a050d7e", SquadId = null, IsPatientZero = false, IsZombie = false, BiteCode = 7462, GameId = 4 },
                new Player { Id = 126, UserID = "98ae3b89-2b66-4113-b369-b06e7af7960e", SquadId = null, IsPatientZero = false, IsZombie = false, BiteCode = 2109, GameId = 4 },
                new Player { Id = 127, UserID = "c6561be2-a927-4cb4-86ad-42867a09f06d", SquadId = null, IsPatientZero = false, IsZombie = false, BiteCode = 3210, GameId = 4 },
                new Player { Id = 128, UserID = "9d394a75-27a0-4a21-b5f3-e0938da2725c", SquadId = null, IsPatientZero = false, IsZombie = false, BiteCode = 2556, GameId = 4 },
                new Player { Id = 129, UserID = "4afba9be-cd98-4070-9cb2-de3aa91e7203", SquadId = null, IsPatientZero = false, IsZombie = false, BiteCode = 9876, GameId = 4 },
                new Player { Id = 130, UserID = "6f90589f-df6b-4e3e-8adb-3986b1b1ae20", SquadId = null, IsPatientZero = false, IsZombie = false, BiteCode = 5698, GameId = 4 },
                new Player { Id = 131, UserID = "4306cf6f-f263-4bcc-a5af-5a4083bf2700", SquadId = null, IsPatientZero = false, IsZombie = false, BiteCode = 3219, GameId = 4 },
                new Player { Id = 132, UserID = "4fef8bff-b177-4919-a3b1-8d5b81bccedd", SquadId = null, IsPatientZero = false, IsZombie = false, BiteCode = 7654, GameId = 4 },
                new Player { Id = 133, UserID = "75eaa26a-6552-4822-8973-94948ccafb22", SquadId = null, IsPatientZero = false, IsZombie = false, BiteCode = 6543, GameId = 4 },
                new Player { Id = 134, UserID = "215a49a4-d9b5-4e86-86ba-35d69781649e", SquadId = null, IsPatientZero = false, IsZombie = false, BiteCode = 3456, GameId = 4 }
                );
            #endregion
